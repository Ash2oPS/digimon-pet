...
def _state_to_payload(state: PetState) -> dict[str, Any]:
    return {
        ...
        "auto_clicker_expires_at": state.auto_clicker_expires_at,
        "speedrun_mode_unlocked": state.speedrun_mode_unlocked,
        "speedrun_mode_enabled": state.speedrun_mode_enabled,
...
def _state_from_dict(raw: dict[str, Any]) -> PetState:
    state = PetState(
        ...
        auto_clicker_expires_at=_optional_int_from_raw(raw.get("auto_clicker_expires_at")),
        speedrun_mode_unlocked=bool(raw.get("speedrun_mode_unlocked", False)),
        speedrun_mode_enabled=bool(raw.get("speedrun_mode_enabled", False)),
